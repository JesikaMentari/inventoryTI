...
<head>
    ...
    <style>
        ...
        .data-section {
            margin-top: 5px;
            /* Further reduced top margin to bring sections closer */
        }
        ...
        .data-table {
            margin-top: 0;
            /* Ensure there's no extra space above the table */
        }

        .data-table td {
            padding: 3px 0;
            /* Reduced padding to bring rows closer */
            vertical-align: top;
            font-size: 16px;
            /* Adjust as needed */
        }
        ...
        .footer {
            clear: both;
            /* Memastikan footer di bawah elemen float */
            margin-top: 40px;
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p>Pada hari ini {{ $hari }}, tanggal {{ \Carbon\Carbon::parse($tanggal)->format('d-m-Y') }}, kami
            ...
            <p>Dengan ini menyatakan bahwa PIHAK PERTAMA telah menyerahkan kepada PIHAK KEDUA dan PIHAK KEDUA telah
                menerima perangkat sebagai berikut:</p>
            ...
            <p>Sejak penandatanganan berita acara ini, maka barang tersebut menjadi tanggung jawab PIHAK KEDUA untuk
                dipergunakan sebagai alat kerja.</p>
