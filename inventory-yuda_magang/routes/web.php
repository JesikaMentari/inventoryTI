...
Route::group(['middleware' => 'userlogin'], function () {
    ...
    Route::middleware(['checkRoleUser:/barang,submenu'])->group(function () {
        ...
        Route::post('/admin/barang/proses_tambah/', [BarangController::class, 'store'])->name('barang.store');
    ...
    Route::middleware(['checkRoleUser:/vendor,submenu'])->group(function () {
        ...
        Route::get('getvendor', [VendorController::class, 'show'])->name('vendor.getvendor');
        Route::post('store', [VendorController::class, 'proses_tambah'])->name('vendor.store');
        Route::put('update/{id}', [VendorController::class, 'proses_ubah'])->name('vendor.update');
        Route::post('/vendor/update', [VendorController::class, 'proses_ubah'])->name('vendor.update');
        Route::put('/vendor/update', [VendorController::class, 'proses_ubah'])->name('vendor.update');
        Route::delete('/vendor/delete/{id}', [VendorController::class, 'proses_hapus'])->name('vendor.delete');
        Route::put('update/{id}', [VendorController::class, 'proses_ubah'])->name('vendor.update');
        Route::put('vendor/update', [VendorController::class, 'proses_ubah'])->name('vendor.update');
    ...
    Route::middleware(['checkRoleUser:/barang-keluar,submenu'])->group(function () {
        ...
        Route::get('/api/cari-bagian', [BagianController::class, 'cariBagian']);
    });
